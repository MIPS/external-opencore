...
#define PV_2WAY_MEDIA_OUTPUT_MIO_NODE_FACTORY_H_INCLUDED
...
{
    public:
        PV2WayMediaOutputMIONodeFactory(PvmiMIOFileInputSettings aFileSettings) :
                iFileSettings(aFileSettings) {};
    ...
    private:
        ...
        PvmiMIOFileInputSettings iFileSettings;
        int CreateMedia();
        void DeleteMedia();
