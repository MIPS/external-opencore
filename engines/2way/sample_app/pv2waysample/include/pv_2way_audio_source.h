 ...
 * -------------------------------------------------------------------
 */
#ifndef PV_2WAY_AUDIO_SOURCE_H_INCLUDED
#define PV_2WAY_AUDIO_SOURCE_H_INCLUDED
////////////////////////////////////////////////////////////////////////////
...
class PV2WayAudioSource : public PV2WaySource
{
    public:
        PV2WayAudioSource(Oscl_Vector<CodecSpecifier*, OsclMemAllocator>* aFormats) :
                PV2WaySource(aFormats)
        {
            iMyType = PV_AUDIO;
        };
        virtual ~PV2WayAudioSource()
        {
