...
int PV2WayVideoSink::CreateMioNodeFactory(CodecSpecifier* aSelectedCodec)
{
    switch (aSelectedCodec->GetType())
    {
        ...
        {
#ifdef PV2WAY_WIN32_GUI
            // input: iPlayOnMediaObserver
            iMioNodeFactory = OSCL_NEW(PV2WayWinVideoMIONodeFactory,
                                       (iPlayOnMediaObserver));
#endif
            break;
        }
        case EPVFileInput:
