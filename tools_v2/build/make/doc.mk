...
ifeq ($(strip $(DEFAULT_DOCMODE)),open)
	doc_open_option := --open
endif

doc_$(doc_target):
	perl $(SRC_ROOT)/tools_v2/build/document/bin/doc_build.bat --doctype $(doc_rule_target) --title $(doc_rule_title) --path $(doc_rule_paths) --filetype "mainpage *.h readme.txt" --exclude_pattern "*/test/* */obsolete/* */doxydir/*" -ver $(doc_rule_version) $(doc_open_option)
