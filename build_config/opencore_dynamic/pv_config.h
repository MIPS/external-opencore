...
#define SOLIBDIRS_opencore_streaming "/nodes/streaming/streamingmanager/build/make /modules/linux_rtsp/core/build/make"
...
#define SOLIBS_opencore_streaming "-lpvstreamingmanagernode -lpvsminterface"
