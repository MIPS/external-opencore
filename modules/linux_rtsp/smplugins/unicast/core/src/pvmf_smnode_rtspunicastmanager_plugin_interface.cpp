...
class RTSPUnicastManagerPluginInterface: public OsclSharedLibraryInterface,
        public SMNodeFSPSharedLibraryInterface
{
    public:
        OsclAny* QueryLibInterface(const OsclUuid& aInterfaceId)
        {
            ...
            {
                return (OsclAny*)(PVMFSMRTSPUnicastNodeFactory::CreateSMRTSPUnicastNodeFactory);
            }
            else if (SMNODE_RELEASE_FSP_LIB_INTERFACE == aInterfaceId)
            {
                return (OsclAny*)(PVMFSMRTSPUnicastNodeFactory::DeleteSMRTSPUnicastNodeFactory);
            }
...
extern "C"
{
    ...
    {
        return OSCL_NEW(RTSPUnicastManagerPluginInterface, ());
    }
