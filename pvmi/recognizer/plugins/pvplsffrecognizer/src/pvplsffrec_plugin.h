 ...
 * -------------------------------------------------------------------
 */
#ifndef PVPLSFFREC_PLUGIN_H_INCLUDED
#define PVPLSFFREC_PLUGIN_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

class PVPLSFFRecognizerPlugin : public PVMFRecognizerPluginInterface
{
    public:
        PVPLSFFRecognizerPlugin()
        {
        };
...
#endif // PVPLSFFREC_PLUGIN_H_INCLUDED
